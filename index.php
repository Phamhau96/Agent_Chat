...
<html lang="en">
    ...
    <head>
        ...
        <title>Ela - Bootstrap Admin Dashboard Template</title>
         Bootstrap Core CSS 
        <link href="include/lib/bootstrap.min.css" rel="stylesheet" type="text/css"/>
         Custom CSS 

        <link href="include/css/lib/calendar2/semantic.ui.min.css" rel="stylesheet">
        <link href="include/css/lib/calendar2/pignose.calendar.min.css" rel="stylesheet">
        <link href="include/css/lib/owl.carousel.min.css" rel="stylesheet" />
        <link href="include/css/lib/owl.theme.default.min.css" rel="stylesheet" />
        <link href="include/css/helper.css" rel="stylesheet">
    ...
    <body class="fix-header fix-sidebar">
        ...
        <div id="main-wrapper">
         ...
         End Wrapper 
         All Jquery 
        <script src="include/js/lib/jquery/jquery.min.js"></script>
         Bootstrap tether Core JavaScript 
        <script src="include/js/lib/bootstrap/js/popper.min.js"></script>
        <script src="include/js/lib/bootstrap/js/bootstrap.min.js"></script>
         slimscrollbar scrollbar JavaScript 
        <script src="include/js/jquery.slimscroll.js"></script>
        Menu sidebar 
        <script src="include/js/sidebarmenu.js"></script>
        stickey kit 
        <script src="include/js/lib/sticky-kit-master/dist/sticky-kit.min.js"></script>
        Custom JavaScript 


         Amchart 
        <script src="include/js/lib/morris-chart/raphael-min.js"></script>
        <script src="include/js/lib/morris-chart/morris.js"></script>
        <script src="include/js/lib/morris-chart/dashboard1-init.js"></script>


        <script src="include/js/lib/calendar-2/moment.latest.min.js"></script>
         scripit init
        <script src="include/js/lib/calendar-2/semantic.ui.min.js"></script>
         scripit init
        <script src="include/js/lib/calendar-2/prism.min.js"></script>
         scripit init
        <script src="include/js/lib/calendar-2/pignose.calendar.min.js"></script>
         scripit init
        <script src="include/js/lib/calendar-2/pignose.init.js"></script>

        <script src="include/js/lib/owl-carousel/owl.carousel.min.js"></script>
        <script src="include/js/lib/owl-carousel/owl.carousel-init.js"></script>
...
<html lang="en">
    ...
    <head>
        ...
        <link href="include/css/lib/chartist/chartist.min.css" rel="stylesheet">
        <link href="include/css/lib/owl.carousel.min.css" rel="stylesheet" />
        <link href="include/css/lib/owl.theme.default.min.css" rel="stylesheet" />
        <!-- Bootstrap Core CSS -->
        <link href="include/css/lib/bootstrap/bootstrap.min.css" rel="stylesheet">
        <!-- Custom CSS -->
        <link href="include/css/helper.css" rel="stylesheet">
        <link href="include/css/style.css" rel="stylesheet">
...
<!--                <div class="container-fluid">
        ...
        <script src="include/js/lib/datamap/d3.min.js"></script>
        <script src="include/js/lib/datamap/topojson.js"></script>
        <script src="include/js/lib/datamap/datamaps.world.min.js"></script>
        <script src="include/js/lib/datamap/datamap-init.js"></script>

        <script src="include/js/lib/weather/jquery.simpleWeather.min.js"></script>
        <script src="include/js/lib/weather/weather-init.js"></script>
        <script src="include/js/lib/owl-carousel/owl.carousel.min.js"></script>
        <script src="include/js/lib/owl-carousel/owl.carousel-init.js"></script>


        <script src="include/js/lib/chartist/chartist.min.js"></script>
        <script src="include/js/lib/chartist/chartist-plugin-tooltip.min.js"></script>
        <script src="include/js/lib/chartist/chartist-init.js"></script>
        <!--Custom JavaScript -->
        <script src="include/js/custom.min.js"></script>
